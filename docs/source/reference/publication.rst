...
.. list-table:: Publications
   ...
   * - Deep reinforcement learning for automated stock trading: An ensemble strategy
     ...
     - `paper <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3690996>`_, `code <https://github.com/DigitalMetro/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020>`_
     - 44
     - 2020
   * - Multi-agent reinforcement learning for liquidation strategy analysis
     ...
     - `paper <https://arxiv.org/abs/1906.11046>`_, `code <https://github.com/DigitalMetro/Liquidation-Analysis-using-Multi-Agent-Reinforcement-Learning-ICML-2019>`_
     - 19
     - 2019
   * - Practical deep reinforcement learning approach for stock trading
     - NeurIPS 2018 Workshop on Challenges and Opportunities for AI in Financial Services
     - `paper <https://arxiv.org/abs/1811.07522>`_, `code <https://github.com/DigitalMetro/DQN-DDPG_Stock_Trading>`_
     - 86
     - 2018
