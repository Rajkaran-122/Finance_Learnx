...
Following the *de facto* standard of OpenAI Gym, we build a universe of market environments for data-driven financial reinforcement learning, namely, FLX-Meta. We keep the following design principles.

1. Layered structure
======================================
.. image:: ../image/flx-meta_overview.png
    :width: 80%
    :align: center
