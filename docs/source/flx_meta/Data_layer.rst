...
.. image:: ../image/flx-meta_data_layer.png
    :width: 60%
    :align: center
...
We connect data APIs of different platforms and unify them using a FLX-Meta data processor. Users can access data from various sources given the start date, end date, stock list, time interval, and kwargs.

.. image:: ../image/FLX-Meta-Data-layer.png
    :width: 80%
    :align: center
...
Raw data retrieved from different data sources are usually of various formats and have erroneous or NaN data (missing data) to different extents, making data cleaning highly time-consuming. In FLX-Meta, we automate the data cleaning process.
