...
class ibkrdownloader:
    ...
    ----------
        start_date : str
            start date of the data (modified from neoflx_config.py)
        end_date : str
            end date of the data (modified from neoflx_config.py)
        ticker_list : list
            a list of stock tickers (modified from neoflx_config.py)
        interval: str
