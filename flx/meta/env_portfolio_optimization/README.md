...
[POE: A General Portfolio Optimization Environment for FLX](https://doi.org/10.5753/bwaif.2023.231144)
```
@inproceedings{bwaif,
 author = {Caio Costa and Anna Costa},
 title = {POE: A General Portfolio Optimization Environment for FLX},
...
## Example
A jupyter notebook using this environment can be found [here](/examples/FLX_PortfolioOptimizationEnv_Demo.ipynb).
